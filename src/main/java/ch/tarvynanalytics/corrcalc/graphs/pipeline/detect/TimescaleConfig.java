 ...
 * market or timescale is wired, not coded.
 *
...
public record TimescaleConfig(int window, DetectorConfig detector, RearmConfig rearm) {
     ...
     * de-fusion <strong>all-clear ENABLED</strong> (validated on the 60-day
    ...
    public static TimescaleConfig cryptoDaily() {
        ...
        // (5 sustained bars below 0.25·h), with the 21-day calendar backstop.
