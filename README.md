...
- [**corrcalc-lib**](https://github.com/tarvyn-analytics/corrcalc-lib)
  (`io.github.tarvyn-analytics.corrcalc:corrcalc-lib-core`) — the online rolling-Pearson
...
- [**graphs-algos-lib**](https://github.com/tarvyn-analytics/graphs-algos-lib)
  (`io.github.tarvyn-analytics.graphs:graphs-algos-lib`) — the temporal change detector
...
**Requires JDK 25.** The two upstream libraries resolve from Maven Central — no
credentials needed. For local work against unreleased library changes, install
each to `~/.m2` once from a sibling checkout:
...
`io.github.tarvyn-analytics.corrcalc.graphs:corrcalc-graphs-pipeline`.
